...
import Login from "./components/ejemplo/Ejemplo";
...
function App() {
  ...
  <ForestLandingPage3 />
    ...
    <div className="sec">
       ...
       <p>Pero no sólo en las aves, también ayuda identificar algunas plantas e insectos, ¿Qué me dices? ¿Nos ayudas a saber qué ocurre en nuestro entorno ahora?  </p>
    ...
    <div className="containerFlex">
      ...
      <button href= "/Ejemplo" className="greenbtn">¡Empezamos!</button>
